...
#define NEUREKA_REG_CONF1 24
#define NEUREKA_REG_STREAMIN_PTR 25
#define NEUREKA_REG_SCALE2_PTR 26
#define NEUREKA_REG_SCALE_SHIFT2_PTR 27
#define NEUREKA_REG_SCALE_BIAS2_PTR 28
#define NEUREKA_REG_PPOLYAPPROX_PTR 29

/*  SHIFT  */

#define NEUREKA_SHIFT_FLAG_INPUT_SIGNED (27)
#define NEUREKA_SHIFT_FLAG_FEAT_BROADCAST (26)
...
#define NEUREKA_POLYAPPROX_DEGREE_0 (0 << 28)
#define NEUREKA_POLYAPPROX_DEGREE_1 (1 << 28)
#define NEUREKA_POLYAPPROX_DEGREE_2 (2 << 28)
#define NEUREKA_FLAG_INPUT_SIGNED (1 << 27)
#define NEUREKA_FLAG_FEAT_BROADCAST (1 << 26)
...
#define NEUREKA_MASK_SHIFT_AMOUNT2 (0x1f << 0)
#define NEUREKA_MASK_PPOLYAPPROX_NR_PARTS (0x1f << 5)
#define NEUREKA_MASK_PPOLYAPPROX_MUL_BW (0x3 << 10)
#define NEUREKA_MASK_PPOLYAPPROX_ADD_BW (0x3 << 12)
#define NEUREKA_MASK_FLAG_POLYAPPROX_DEGREE (0x3 << 28)
#define NEUREKA_MASK_FLAG_INPUT_SIGNED (0x1 << 27)
#define NEUREKA_MASK_FLAG_FEAT_BROADCAST (0x1 << 26)
